...
exports.save_pattern = async (req, res) => {
    ...
    // Crear la carpeta public/uploads/markers/${req.body.id}
    fs.mkdirSync(`public/uploads/markers/${req.body.id}`, { recursive: true });
    ...
    fs.writeFile(filePath, patternFileString, function(err) {
        if (err) {
            ...
            // Guardamos en la misma carpeta la imagen req.body.fullMarkerURL
